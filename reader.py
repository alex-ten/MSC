...
def _build_mini_vocab(filename, sorted_words_only=False):
...
def raw_data(data_path=None):
  ...
  word_to_id = _build_mini_vocab(train_path)
...
def reader_demo():
    ...
    # print(_file_to_word_ids(file, _build_mini_vocab(file)))
    #
    # print('\nAdd step. Sort unique words by frequency or alphabetically:')
    # print(_build_mini_vocab(file, True))
...
if __name__=='__main__': reader_demo()